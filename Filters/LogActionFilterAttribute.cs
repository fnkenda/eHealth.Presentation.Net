...
namespace eHealth.Presentation.Filters
{
    public class LogActionFilterAttribute : ActionFilterAttribute
    {
        ...
        public LogActionFilterAttribute(IWebHostEnvironment webHostEnvironment)
        {
        ...
        public override void OnResultExecuted(ResultExecutedContext filterContext)
        {
            ...
            using (StreamWriter sw = new StreamWriter(fs))
            {
                sw.WriteLine($"The action {actionName} in {controllerName} Controller has the following viewData : " +
                    $"{result.ViewData.Values.FirstOrDefault()}, event fired: OnResultExected");
            }
        }
    }
}
